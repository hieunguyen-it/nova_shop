...
import { AuthResponse, RefreshTokenReponse } from '@/types'
import { isAxiosExpiredTokenError, isAxiosUnauthorizedError } from './ultils'
  ...
  constructor() {
    ...
    this.instance = axios.create({
      ...
      headers: {
        ...
        'expire-refresh-token': 20 // 160 ngày
      }
    })
